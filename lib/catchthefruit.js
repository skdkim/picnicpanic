...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const update = () => {
    ...
    ctx.fillStyle = 'black';
    currentAccuracy = Math.round((fruits.caughtCount() / currentTotal || 0) * 100);
    ctx.fillText(`Caught:${fruits.caughtCount()} Missed:${fruits.missedCount()} Accuracy:${currentAccuracy}%`, 0, 30);
